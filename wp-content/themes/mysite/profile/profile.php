...
<body>
  ...
  <div class="BlkWrap">
    ...
    <div class="BlkContent">
      ...
      <!--BlkMain start-->
      <main class="BlkMain -pc" style="background-image: url(images/main.jpg);">
      </main>
			<main class="BlkMain -res" style="background-image: url(images/main_res.jpg);">
      </main>
      <!--BlkMain end-->
